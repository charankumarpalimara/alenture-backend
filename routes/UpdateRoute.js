...
const  { updateCmProfile, updateCmProfileByAdminHob, updateCmProfileByAdminHobV2 } = require('../controllers/Profile/update/CmProfileUpdate');
...
router.post('/updateCmProfileByAdminHobV2', multer({
    storage: multer.diskStorage({
        destination: (req, file, cb) => {
            cb(null, path.join(__dirname, '../uploads/cm'));
        },
...
}).single('cmProfileImageByAdminHobV2'), updateCmProfileByAdminHobV2);
